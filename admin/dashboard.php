...
<body>
    ...
    <div class="container">
        ...
        <div class="dashboard-grid">
            <a href="/LibraryBorrowingSystem/admin/staff_management.php" class="card-link">
                <div class="card">
                    <h2>Staff Management</h2>
                    <p>Add staff accounts, reset passwords, and manage account status.</p>
                </div>
            </a>
            
            <a href="/LibraryBorrowingSystem/admin/reports.php" class="card-link">
                <div class="card">
                    <h2>Reports & Analytics</h2>
                    <p>Generate detailed reports on borrowing trends, returns, inventory, and system usage.</p>
                </div>
            </a>
            
            <a href="/LibraryBorrowingSystem/admin/student_records.php" class="card-link">
                <div class="card">
            ...
            <a href="/LibraryBorrowingSystem/admin/inventory.php" class="card-link">
                <div class="card">
                    <h2>Add Book</h2>
            ...
            <a href="/LibraryBorrowingSystem/admin/qr_transaction.php" class="card-link">
                <div class="card">
            ...
            <a href="/LibraryBorrowingSystem/admin/qr_transaction.php" class="card-link">
                <div class="card">
                    <h2>Book Returns</h2>
                    <p>Record same-day book returns using the QR scanner.</p>
                </div>
            </a>
            ...
            <a href="/LibraryBorrowingSystem/admin/transactions.php" class="card-link">
                <div class="card">
                    <h2>Transactions</h2>
