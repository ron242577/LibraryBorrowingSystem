<?php
/**
 * Unified Book Transactions Page - Admin Panel
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" id="transactionForm"
              data-confirm-title="Confirm Transaction"
              data-confirm-message="Process this book transaction?"
              data-confirm-text="Process">
            <?php echo csrfField(); ?>
    ...
    <script>
        ...
        function renderBookSummary(book, mode) {
            ...
            document.getElementById('bookSummaryGrid').innerHTML =
                ...
                (book.volumes ? summaryItem('Volumes', book.volumes) : '') +
                (book.class ? summaryItem('Class', book.class) : '') +
                (book.source_of_funds ? summaryItem('Source of Funds', book.source_of_funds) : '') +
                (book.cost_price !== null && book.cost_price !== '' ? summaryItem('Cost Price', '₱' + Number(book.cost_price).toFixed(2)) : '') +
        ...
        function updateSteps() {
            ...
            if (!bookValid || !transactionMode) {
                ...
                document.getElementById('transactionForm').setAttribute('data-confirm-title', 'Confirm Book Return');
                ...
                document.getElementById('transactionForm').setAttribute('data-confirm-title', 'Confirm Book Borrowing');
                document.getElementById('transactionForm').setAttribute('data-confirm-message', 'Borrow this book for the confirmed student? It must be returned within the same day.');
                document.getElementById('transactionForm').setAttribute('data-confirm-text', 'Borrow Book');
