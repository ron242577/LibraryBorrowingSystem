<?php
/**
 * Teacher Book Borrowing Page - Jose Abad Santos High School
...
<div class="teacher-menu">
            ...
            <div class="teacher-dropdown" id="teacherDropdown">
                ...
                <?php endif; ?>
                <a href="/LibraryBorrowingSystem/teacher/borrow.php" class="active">Search Books</a>
            ...
            <div class="teacher-info-section">
                <?php if ($teacher_error): ?>
                    <div class="error-box">
                        ...
                        <p><?php echo htmlspecialchars($teacher_error); ?></p>
                    </div>
                <?php elseif ($teacher): ?>
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">TEA-<?php echo str_pad($teacher['teacher_id'], 4, '0', STR_PAD_LEFT); ?></div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo countActiveBorrowings($conn, $teacher_id); ?> / <?php echo (int)$max_active_books; ?></div>
                        </div>
                    </div>
                    ...
                    <div class="qr-section">
                        <h4>QR Code</h4>
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo urlencode($teacher['qr_code']); ?>" 
                             alt="Teacher QR Code">
                        <div class="qr-text"><?php echo htmlspecialchars($teacher['qr_code']); ?></div>
                        <a class="qr-download-btn" href="/LibraryBorrowingSystem/teacher/download_qr.php">Download Teacher QR</a>
                    </div>
                <?php else: ?>
...
function selectBook(bookId, title, availableCopies, element = null) {
    ...
    document.getElementById('selectedBookQRDownload').href = '/LibraryBorrowingSystem/teacher/download_book_qr.php?book_id=' + encodeURIComponent(book.book_id);
